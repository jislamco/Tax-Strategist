        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="text-sm">
            ...
            <tr className="border-b border-slate-100">
             ...
             {/* PIT Section */}
             <tr className="bg-slate-50/50"><td colSpan={selectedCountries.length + 1} className="p-2 px-4 text-xs font-bold text-indigo-600 uppercase tracking-wider">Personal Income Tax</td></tr>
             <tr className="border-b border-slate-100">
